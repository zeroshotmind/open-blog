...
seriesOrder: 2
tags: ["linear-algebra", "inner-product", "cosine-similarity", "dot-product", "geometry"]
authors:
  - name: "Swastik Roy"
    orcid: ""
summary: "What does it mean for two vectors to be similar? Inner products measure alignment between vectors — and cosine similarity is just the dot product with magnitudes divided out."
---
